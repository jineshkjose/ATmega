...
#define UCSZ0  U_UCSRB.bit.B1
#define UCSZ1  U_UCSRB.bit.B2
#define USBS   U_UCSRB.bit.B3
#define UPM0   U_UCSRB.bit.B4
#define UPM1   U_UCSRB.bit.B5
#define UMSEL  U_UCSRB.bit.B6
#define URSEL  U_UCSRB.bit.B7
